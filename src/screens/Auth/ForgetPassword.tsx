        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <View className="justify-between flex-1 p-3">
            ...
            <View className=" items-center ">
              ...
              <View className="flex-row justify-between items-center mt-2 mb-2 border-2 p-3 rounded-2xl border-[#E9D5FF] bg-white w-full" style={{paddingVertical:15}}>
                <TextInput placeholder="Enter your email" placeholderTextColor={"#ADAEBC"} />
              ...
              <View className="w-full ">
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate("Success page")}
                >
                  <LinearGradient
